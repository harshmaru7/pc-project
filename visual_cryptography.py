# This module is used to handle visual cryptography related operations
...
class visual_cryptography:
	...
	def encrypt(self):
		...
		file_red=open('red_pixel'+str(self.number),'w')
		...
		file_green=open('green_pixel'+str(self.number),'w')
		...
		file_blue=open('blue_pixel'+str(self.number),'w')
